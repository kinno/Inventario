            ...
            <div class="panel panel-default panel-body inputsPrincipales">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <table id="tablaVentas" class="table table-bordered">
                            ...
                            <tfoot>
                                <tr><td colspan="6"></td><td style="text-align:right; font-weight: bold;">Total: <span>$<span class="number" id="totalVenta">0.00</span></span></td><td style="width:5%"></td></tr>
                            </tfoot>
                        </table>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-1 col-md-offset-10">
                        <span id="guardarVenta" onclick="guardarVenta();" class="btn btn-success">Aceptar</span>
                    </div>
                </div>
